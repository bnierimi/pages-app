...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className={`font-sans bg-zinc-100 dark:bg-zinc-900 text-zinc-700 dark:text-zinc-200`}>

        {/* (frame) */}
        <section className="h-mobileScreen md:h-screen w-full relative flex items- md:space-x-2 md:p-2">
        
          {/* (frame): aside */}
          <aside className="h-full w-3/12 hidden relative md:flex md:flex-col rounded-xl space-y-2">
